...
public abstract class Scheduler {
	...
	/**
	 * @return true if there are any Jobs in the com.egurnee.school.os.p3.sample (could be running, ready, or 
	...
	/**
	 * return true if the com.egurnee.school.os.p3.sample has jobs in any queues (ready, or IO queues 
