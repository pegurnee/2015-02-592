...
class SystemSimulator extends Thread
{
  ...
  private final Scheduler myScheduler; // com.egurnee.school.os.p3.sample for jobs	
...
public void run()
  {
    ...
    // loop while we have jobs left to be scheduled or com.egurnee.school.os.p3.sample has jobs scheduled
  ...
  public void exit()
  {
	  // remove job from com.egurnee.school.os.p3.sample, record data into gannt chart
